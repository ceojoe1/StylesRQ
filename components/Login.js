...
class Login extends Component {
    ...
    render() {
                    ...
                    <Spinner visible = {this.state.visibleLogin} textContent={'Signing into Google...'} textStyle={{color: '#FFF'}} overlayColor = {'rgba(0, 0, 0, 0.7)'} />
                        ...
                        <View style = {styles.loginView}>
                            ...
                            <TouchableOpacity onPress = { () => {this._signIn();}} style = {styles.buttonContainer}>
                                <Image source = {require('./img/google_button_icon_wb.png')} style = {styles.buttonImage} />
         ...
         */
            ...
            return (
               <View>
                   {this.props.navigation.dispatch(NavigationActions.navigate({routeName: 'Home', params: {user: this.state.user}}))}
                   </View>
            ); 
        }
    }
    ...
    async _setupGoogleSignin() {
        try {
            ...
            await GoogleSignin.configure({
                webClientId: '553252235288-5aib32j999bsakgco58f2qo2hi9loucr.apps.googleusercontent.com',
                offlineAccess: false
            }).then(() => {
                return;
            });
